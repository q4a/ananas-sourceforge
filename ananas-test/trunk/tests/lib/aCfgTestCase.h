/****************************************************************************
** $Id: aCfgTestCase.h,v 1.2 2007/03/12 20:10:16 gr Exp $
**
...
#ifndef QTUNIT_ACFGTEST_H
#define QTUNIT_ACFGTEST_H
...
{
	class aCfgTest : public TestCase
	{
	protected:
		QString cfgFile;
		QString cfgFileTest;
